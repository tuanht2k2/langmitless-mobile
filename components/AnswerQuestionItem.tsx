  ...
  interface AnswerQuestionItemProps {
    ...
    handleSelectOption: (questionId: string | undefined, optionId: string) => void;
    startRecording: () => void;
    stopRecording: () => void;
    handleGoToPrev: () => void;
    handleGoToNext: () => void;
            ...
            {item.type === "Pronunciation" ? (
              <>
                <View style={{ alignItems: 'center' }}>
                  <Text style={{ fontSize: 14, color: '#6c757d' }}>Phát âm đúng</Text>
                  <Text style={{ fontSize: 20, fontWeight: 'bold', color: '#28a745' }}>
                    {(questionScores[item.id as string]?.pronunciationScore || 0).toFixed(1)}%
                  </Text>
                </View>
                <View style={{ alignItems: 'center' }}>
                  <Text style={{ fontSize: 14, color: '#6c757d' }}>Điểm phát âm</Text>
              ...
              <>
                <View style={{ alignItems: 'center' }}>
                  <Text style={{ fontSize: 14, color: '#6c757d' }}>Điểm câu này</Text>
                  <Text style={{ fontSize: 22, fontWeight: 'bold', color: '#007bff' }}>
                    {(questionScores[item.id as string]?.score || 0).toFixed(1)} / 10
                  </Text>
                </View>
              </>
            )}
            ...
            <View style={{
              ...
              {item.audioSample && (
                ...
                >
                  ...
                  <Text style={{color: "#fff", fontWeight: "600"}}>Nghe mẫu</Text>
                </TouchableOpacity>
              )}
              ...
              {audioUri && (
                <TouchableOpacity
                  onPress={() => playAudio(audioUri, playbackSound, setPlaybackSound)}
                  style={{
                    flex: 1,
                    paddingVertical: 12,
                    borderRadius: 8,
                ...
                >
                  <Ionicons name="play-circle" size={16} color="#fff" style={{marginRight: 8}}/>
                  <Text style={{color: "#fff", fontWeight: "600"}}>Nghe lại</Text>
                </TouchableOpacity>
              )}
            </View>
          </View>
                      ...
                      {isSelected && (
                        <View
                          style={{
                            ...
                            width: 12,
                            borderRadius: 6,
                            backgroundColor: isAnswerWrong ? "#f44336" : "#2196F3",
                          }}
                        />
                      )}
                    </View>
